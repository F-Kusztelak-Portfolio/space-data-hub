...
public class TestObjectFactory {
  ...
  public static class NewMission {
    ...
    public static Mission differentMission =
        Mission.builder()
  ...
  public static class ProductList {
    ...
    public static Product productFirst =
        Product.builder().acquisitionDate(LocalDate.parse(Dates.FIRST_DATE)).build();
    public static Product productFifth =
        Product.builder().acquisitionDate(LocalDate.parse(Dates.FIFTH_DATE)).build();
    private static Product productSecond =
        Product.builder().acquisitionDate(LocalDate.parse(Dates.SECOND_DATE)).build();
    public static List<Product> datesLower = Arrays.asList(productFirst, productSecond);
    private static Product productThird =
        Product.builder().acquisitionDate(LocalDate.parse(Dates.THIRD_DATE)).build();
    private static Product productForth =
        Product.builder().acquisitionDate(LocalDate.parse(Dates.FOURTH_DATE)).build();
    public static List<Product> datesAll =
        Arrays.asList(productFirst, productSecond, productThird, productForth, productFifth);
    public static List<Product> datesGreater = Arrays.asList(productForth, productFifth);

    public static List<Product> datesBetween =
        Arrays.asList(productSecond, productThird, productForth);
  ...
  public static class NewProduct {
    ...
    public static Product productPurchased = Product.builder().purchased(true).build();

    public static Product productNotPurchased = Product.builder().purchased(false).build();
